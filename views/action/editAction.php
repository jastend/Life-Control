...
`apple`='".$psApple."', `peach`='".$psPeach."', `salt`='".$psSalt."', `sand`='".$psSand."', `rock`='".$psRock."', `frog`='".$psFrog."', `oilu`='".$psOilu."', `uranu`='".$psUranu."', `copperore`='".$psCopperore."', `coal`='".$psCoal."', `ironore`='".$psIronore."', `silver`='".$psSilver."', `gold`='".$psGold."', `diamond`='".$psDiamond."', `cannabis`='".$psCannabis."', `cocaine`='".$psCocaine."', `heroinu`='".$psHeroinu."' WHERE `playerid` = '".$pId."'";
