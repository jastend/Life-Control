                    ...
                    <div class="col-lg-12">
						...
						<div class="col-lg-4" style="top:3px;float:right;">
							<form style="float:right;" method='post' action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" name='searchPlayer'>
                                ...
                                <input class='btn btn-sm btn-primary'  type='submit'  name='edit' value='Search Text'>
							</form>
						</div>
                        <ol class="breadcrumb">
                            <li class="active">
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-envelope-o fa-fw"></i> Messages
                            </div>
                                                ...
                                                <?php
                                                    if (!$db_connection->connect_errno) 
                                                    {
                                                        ...
                                                        if (isset($_POST['searchText']))
                                                        {
                                                            ...
                                                            $sql = "SELECT * FROM `messages` WHERE `message` LIKE '%".$searchText."%' ORDER BY `time` DESC ;";
                                                        }
                                                        else
                                                        {
